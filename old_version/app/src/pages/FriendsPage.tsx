  ...
  return (
    <div style={{ minHeight: '100vh', paddingTop: '140px', paddingBottom: '80px', backgroundColor: 'var(--color-bg)' }}>
      <div ref={contentRef} style={{ maxWidth: '800px', margin: '0 auto', padding: '0 40px' }}>
        ...
        <h1 style={{ fontFamily: 'var(--font-display)', fontSize: 'clamp(28px, 4vw, 42px)', fontWeight: 300, lineHeight: 1.3, marginBottom: '16px', color: 'var(--color-text)', letterSpacing: '-0.02em' }}>
          晓宇的朋友们
        </h1>
        <p style={{ fontFamily: 'var(--font-body)', fontSize: '15px', fontWeight: 400, lineHeight: 1.8, color: 'var(--color-text-secondary)', marginBottom: '60px' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(300px, 1fr))', gap: '20px' }}>
          {friends.map((friend, i) => (
            ...
            >
              ...
              <span style={{ fontFamily: 'var(--font-display)', fontSize: '11px', fontWeight: 400, letterSpacing: '0.1em', color: 'var(--color-accent)', display: 'block', marginBottom: '12px', textTransform: 'uppercase' }}>
                {friend.title}
              </span>
              <p style={{ fontFamily: 'var(--font-body)', fontSize: '14px', fontWeight: 400, lineHeight: 1.7, color: 'var(--color-text-secondary)' }}>
                {friend.description}
              </p>
            </a>
          ))}
